...
porc.metricas.validas <- obras.metricas.relevantes %>%  
    ...
    summarise(
              ...
              medicoes_ok = sum(medicoes_ok_valida == TRUE & medicoes_ok_opcional == FALSE) / n(),
...
A mediana de critérios válidos por município é cerca de 57% e os mesmos tem pequena variação, visto que 50% dos municípios preenchem entre cerca de 53% e 64% dos critérios. Apesar da baixa variação, existem municípios que se destacaram positivamente, tendo 80% dos critérios preenchidos.

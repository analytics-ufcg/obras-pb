...
tb.dados.municipios <- tb.dados.municipios %>% 
    mutate(
        ...
        situacao_estimada = ifelse(!is.na(situacao) & situacao %in% c(7, 8) | !is.na(data_conclusao_obra) | !is.na(data_recebimento_obra),
                          "CONCLUÍDA",
...
* num_fotos_acompanhamento - 0 fotos de acompanhamento, caso a obra tenha mais de 90 dias e o valor seja acima de R$30.000,00
...
obras.metricas.relevantes <- tb.dados.municipios %>% 
    mutate(
        ...
        num_fotos_acompanhamento_valida = num_fotos_acompanhamento > 0 | (valor_obra > 10000 & valor_obra <= 30000) | tempo.de.obra <= 90,

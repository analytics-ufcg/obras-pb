...
get.data.faltantes(con1, con2, mapa_paraiba)
...
tb.dados.municipios <- obras.2013 %>% 
    ...
    mutate(tem_georreferenciamento_valido = ifelse(is.na(tem_georreferenciamento_valido), FALSE, tem_georreferenciamento_valido),
           ...
           dentro_municipio = ifelse(is.na(dentro_municipio_valido), "NÃO CONSTA", 
                                             ifelse(tipo_georeferenciamento == 2, "TALVEZ", 
...
* dentro_municipio(apenas os que tiverem georreferenciamento do tipo 1 ou 3):
    ...
    + INCERTO: As que tiverem tempo de obra menor ou igual à 90 dias ou valor da obra menor que R$10.000,00 ou as que tiverem georreferenciamento do tipo 2
    + INVÁLIDO: As demais
* planilha_contratada:
    + OPCIONAL: Obras com valor maior ou igual à R$10.000,00 e menor que R$30.000,00
        ...
        corretude_dentro_municipio = factor(ifelse(valor_obra >= 10000 & valor_obra < 30000, "OPCIONAL",
                                            ifelse(dentro_municipio == "SIM", "VALIDO",
                                                   ifelse(tempo.de.obra <= 90 | valor_obra < 10000 | 
                                                              dentro_municipio == "TALVEZ", "INCERTO", "INVALIDO")))),
...
A mediana de critérios válidos por município é cerca de 44% e os mesmos tem pequena variação, visto que 50% dos municípios preenchem entre cerca de 42% e 47% dos critérios. Apesar da baixa variação, existem municípios que se destacaram positivamente, tendo cerca de 59% dos critérios preenchidos.

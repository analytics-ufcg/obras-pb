...
obras.metricas.relevantes <- tb.dados.municipios %>% 
    mutate(
        ...
        medicoes_ok_valida = grepl(".xls", medicoes_ok) | grepl(".pdf", medicoes_ok),
        num_fotos_valida = num_fotos > 0
    )
```

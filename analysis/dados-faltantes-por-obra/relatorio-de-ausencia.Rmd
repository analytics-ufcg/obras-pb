...
* num_fotos_medicao:
    + OPCIONAL: Obras com valor maior ou igual à R$10.000,00 e menor que R$150.000,00
    + VÁLIDO: As que possuem no mínimo uma foto por medição
    + INCERTO: As que tiverem valor da obra menor que R$10.000,00
    + INVÁLIDO: As demais
...
* tem_acompanhamento_final
    ...
    + INCERTO: As que possuem menos ou igual à 90 dias passados da data prevista de conclusão ou valor menor que R$10.000,00 
    + INVÁLIDO: As demais
* numero_obra:

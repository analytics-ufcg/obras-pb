...
tb.dados.municipios <- obras.2013 %>% 
    ...
    mutate(tem_acompanhamento_inicial_valido = !is.na(tem.acomp.inicial) & tem.acomp.inicial,
           ...
           tem_acompanhamentos = ifelse(tem_acompanhamento_inicial_valido & tem_acompanhamento_final_valido, "SIM", "NÃO")) %>% 
...
obras.metricas.relevantes <- tb.dados.municipios %>% 
    mutate(
        ...
        tem_acompanhamentos_inicial_valido = tem_acompanhamento_inicial_valido | tempo.de.obra <= 90 | tem_acompanhamentos_opcional,

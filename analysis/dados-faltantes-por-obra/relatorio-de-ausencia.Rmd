    ...
    show_plot(mun, porc.dados.validos, print(
        obras.filt.mun %>% 
            ...
            formattable(list(
              tipo_obra = formatter(
                "span",
                style = ~ style("background-color" = ifelse(tipo_obra_valida , "green", "red"),
                                display = "block")),
              tipo_obra_valida = FALSE,
              valor_obra = formatter(
                "span",
                style = ~ style("background-color" = ifelse(valor_obra_valida , "green", "red"),
                                display = "block")),
              valor_obra_valida = FALSE,
              dimensao = formatter(
                "span",
                style = ~ style("background-color" = ifelse(dimensao_valida , "green", "red"),
                                display = "block")),
              dimensao_valida = FALSE,
              dentro_municipio = formatter(
                "span",
                style = ~ style("background-color" = ifelse(dentro_municipio , "green", "red"),
                                display = "block")),
              planilha_contratada = formatter(
                "span",
                style = ~ style("background-color" = ifelse(planilha_contratada_valida , "green", "red"),
                                display = "block")),
              planilha_contratada_valida = FALSE,
              numero_contrato = formatter(
                "span",
                style = ~ style("background-color" = ifelse(numero_contrato_valido , "green", "red"),
                                display = "block")),
              numero_contrato_valido = FALSE,
              data_inicio_obra = formatter(
                "span",
                style = ~ style("background-color" = ifelse(!is.na(data_inicio_obra) , "green", "red"),
                                display = "block")),
              data_prevista_conclusao = formatter(
                "span",
                style = ~ style("background-color" = ifelse(data_prevista_conclusao_valida , "green", "red"),
                                display = "block")),
              data_prevista_conclusao_valida = FALSE,
              data_conclusao_obra = formatter(
                "span",
                style = ~ style("background-color" = ifelse(data_conclusao_obra_valida , "green", "red"),
                                display = "block")),
              data_conclusao_obra_valida = FALSE,
              data_recebimento_obra = formatter(
                "span",
                style = ~ style("background-color" = ifelse(data_recebimento_obra_valida , "green", "red"),
                                display = "block")),
              data_recebimento_obra_valida = FALSE,
              total_de_medicoes = formatter(
                "span",
                style = ~ style("background-color" = ifelse(total_de_medicoes_valida , "green", "red"),
                                display = "block")),
              total_de_medicoes_valida = FALSE,
              medicoes_ok = formatter(
                "span",
                style = ~ style("background-color" = ifelse(medicoes_ok_valida , "green", "red"),
                                display = "block")),
              medicoes_ok_valida = FALSE,
              num_fotos = formatter(
                "span",
                style = ~ style("background-color" = ifelse(num_fotos_valida , "green", "red"),
                                display = "block")),
              num_fotos_valida = FALSE,
              tem_georreferenciamento = formatter(
                "span",
                style = ~ style("background-color" = ifelse(tem_georreferenciamento , "green", "red"),
                                display = "block"))
          )) %>%
          as.datatable(
              options = list(

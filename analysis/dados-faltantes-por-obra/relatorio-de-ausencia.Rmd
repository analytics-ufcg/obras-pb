...
* numero_art:
    ...
    + INVÁLIDO: Os demais
* valor_obra:
    + INVÁLIDO: Obras que tiverem valor igual à zero
    + VÁLIDO: As que tiverem valor maior ou igual à R$10.000,00 e menor que R$100.000.000,00
    + INCERTO: As que tiverem valor menor que R$10.000,00
* dimensao:
...
* tem_georreferenciamento:
    ...
    + INCERTO: As que tiverem tempo de obra menor que 90 dias ou valor da obra menor que R$10.000,00
    + INVÁLIDO: As demais
...
* tem_acompanhamento_final
    ...
    + INCERTO: As que possuem mais de 90 dias passados da data prevista de conclusão ou valor menor que R$10.000,00 
    + INVÁLIDO: As demais
* numero_obra:
...
obras.metricas.relevantes <- tb.dados.municipios %>% 
    mutate(
        ...
        corretude_valor_obra = ifelse(valor_obra == 0, "INVALIDO",
                                      ifelse(valor_obra >= 10000 & valor_obra < 100000000, "VALIDO",
                                        ifelse(valor_obra < 10000, "INCERTO"))),

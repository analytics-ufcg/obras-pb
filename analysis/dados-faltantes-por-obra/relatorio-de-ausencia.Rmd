...
obras.metricas.relevantes <- tb.dados.municipios %>% 
    mutate(
        ...
        dentro_municipio_valido = (!is.na(dentro_municipio_valido) & dentro_municipio_valido) | tempo.de.obra <= 90 | dentro_municipio_opcional,
...
obras.metricas.relevantes <- obras.metricas.relevantes %>% 
    ...
    mutate(
        criterios_validos = sum(numero_art_valido & !numero_art_opcional, valor_obra_valida, dimensao_valida, 
                            ...
                            !is.na(dentro_municipio_valido) & dentro_municipio_valido & !dentro_municipio_opcional, 

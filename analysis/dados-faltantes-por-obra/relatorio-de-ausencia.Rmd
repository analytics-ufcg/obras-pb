...
obras.metricas.relevantes <- tb.dados.municipios %>% 
    mutate(
        ...
        numero_art_valido = str_detect(numero_art, paste0("(P|p)(B|b)(",lubridate::year(data_inicio_obra), "|1900)([:digit:]{7})")) | lubridate::year(data_inicio_obra) < 2015,
...
df %>% 
    ggplot(aes(x = reorder(colunas, porcentagem.criterios.validos), y = porcentagem.criterios.validos)) +
    geom_bar(stat = "identity") +
    labs(x = "Critérios", y = "Porcentagem de dados válidos", title = "Porcentagem dos critérios válidos") +
    coord_flip() +

...
p <- plot_ly(evolucao_tipos, x =~ano, y = ~custo_total, color = ~nome, type = 'bar', orientation = 'v'
        ) %>%
...
### Investimento Dedicado a Cada Tipo de Obra (Desde 2012)
...
p <- plot_ly(evolucao_tipos_a, x =~valor_total , y = ~nome, color = ~nome, type = 'bar', orientation = 'h'

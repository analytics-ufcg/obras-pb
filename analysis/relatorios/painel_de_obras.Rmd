...
perc_ativas <- round(100 * valor_ativas / valor_obras, 2)

gauge(perc_ativas, min = 0, max = 100, symbol = "%",
      gaugeSectors(danger = c(0, 33), warning = c(34, 66), success = c(67, 100)))
...
perc_finalizadas <- round(100 * valor_finalizadas / valor_obras, 2)

gauge(perc_finalizadas, min = 0, max = 100, symbol = "%",
      gaugeSectors(danger = c(0, 33), warning = c(34, 66), success = c(67, 100)))

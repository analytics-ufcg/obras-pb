...
```{r, warning=FALSE}
obra.valor.localidade.data <- acompanhamento %>% 
...
Vemos que a mediana dos valores zerados a partir de 2014 é 0%, mas existem alguns outliers, como Natuba, São José de Princesa e Araruna.
...
* Tabela obra:
    ...
    + As cidades que mais tem valor da obra zerado:
        1. Natuba, tendo 10 obras, sendo 40% com valor zero.
        2. São José de Princesa, tendo 3 obras, sendo 33.3% com valor zero.
        3. Araruna, tendo 16 obras, sendo 31.25% com valor zero.
        4. Mamanguape, tendo 16 obras, sendo 25% com valor zero.

...
Vejamos primeiramente a quantidade de obras por município:
...
Vejamos agora um o valor gasto em obras por habitante em cada município:
...
obras.filtradas.valor %>% 
    ...
    arrange(-valor_obra) %>% select(nome.x, valor_obra, descricao_sucinta_obra, descricao_localidade) %>%
    top_n(5) %>% 
    kable()
```

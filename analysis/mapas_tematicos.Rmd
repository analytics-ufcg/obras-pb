...
obras.2013 <- obras.2013 %>% 
    left_join(municipios, by = c("nome.x" = "nome")) %>% 
...
mapa_paraiba %>% 
    ...
    addPolygons(opacity = 0.5, 
              ...
              color = "black", 
              label = mapa_paraiba@data$Nome_Munic,
              popup = paste("Município: ", mapa_paraiba@data$Nome_Munic, "</br>Valor em obras por habitante: R$", mapa_paraiba@data$gastos.por.habitante, "</br>Valor total das obras: R$", mapa_paraiba@data$valor.total.obras, "</br>Quantidade de habitante: ", mapa_paraiba@data$populacao),
              fillOpacity = 1) %>%

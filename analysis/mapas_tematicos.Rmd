...
colors <- paleta.de.cores(dado = mapa_paraiba_quantidade_obras@data$qtde.obras)

cria.mapa(
    mapa_paraiba_quantidade_obras, 
    mapa_paraiba_quantidade_obras@data$qtde.obras, 
    ...
    colors, 
    "Quantidade de obras por município"
    )
```
...
colors <- paleta.de.cores(dado = mapa_paraiba_gasto_habitante@data$gastos.por.habitante)

cria.mapa(
    mapa_paraiba_gasto_habitante, 
    mapa_paraiba_gasto_habitante@data$gastos.por.habitante, 
    ...
    colors, 
    "Valor gasto em obras por habitante"
    )
```
...
colors <- paleta.de.cores(dado = mapa_paraiba_custo_efetivo@data$custo_efetivo)

cria.mapa(
    mapa_paraiba_custo_efetivo,
    mapa_paraiba_custo_efetivo@data$custo_efetivo, 
    mapa_paraiba_custo_efetivo@data$Nome_Munic, 
    paste('Município: ', mapa_paraiba_custo_efetivo@data$Nome_Munic, '</br>Custo efetivo: R$', format(mapa_paraiba_custo_efetivo@data$custo_efetivo, digits = 2, big.mark=".", decimal.mark = ",", scientific = FALSE)), 
    colors, 
    "Custo efetivo mediano das obras"
    )
```

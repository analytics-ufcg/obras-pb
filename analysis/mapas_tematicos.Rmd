...
colors <- colorNumeric("viridis", domain = c(min(mapa_paraiba_quantidade_obras@data$qtde.obras.log, na.rm = T), max(mapa_paraiba_quantidade_obras@data$qtde.obras.log, na.rm = T)))
...
mapa_paraiba_quantidade_obras %>% 
    ...
    addPolygons(opacity = 0.5, 
              weight = 1, 
              fillColor = colors(mapa_paraiba_quantidade_obras@data$qtde.obras.log),
              color = 'black', 
              ...
              fillOpacity = 1) %>%
    addLegend(position = "bottomright", pal = colors, values = mapa_paraiba_quantidade_obras@data$qtde.obras.log,
            title = "Log da quantidade de </br> obras por município",
            opacity = 1)
```
...
colors <- colorNumeric("viridis", domain = c(min(mapa_paraiba_gasto_habitante@data$gasto.por.habitante.log, na.rm = T), max(mapa_paraiba_gasto_habitante@data$gasto.por.habitante.log, na.rm = T)))
...
mapa_paraiba_gasto_habitante %>% 
    ...
    addPolygons(opacity = 0.5, 
              weight = 1, 
              fillColor = colors(mapa_paraiba_gasto_habitante@data$gasto.por.habitante.log),
              color = "black", 
              ...
              fillOpacity = 1) %>%
    addLegend(position = "bottomright", pal = colors, values = mapa_paraiba_gasto_habitante@data$gasto.por.habitante.log,
            title = "Log de valor gasto em </br> obras por habitante",
            opacity = 1)
```
...
colors <- colorNumeric("viridis", domain = c(min(mapa_paraiba_custo_efetivo@data$custo.efetivo.log, na.rm = T), max(mapa_paraiba_custo_efetivo@data$custo.efetivo.log, na.rm = T)))
...
mapa_paraiba_custo_efetivo %>% 
    ...
    addPolygons(opacity = 0.5, 
              weight = 1, 
              fillColor = colors(mapa_paraiba_custo_efetivo@data$custo.efetivo.log),
              color = 'black', 
              label = mapa_paraiba_custo_efetivo@data$Nome_Munic,
              popup = paste('Município: ', mapa_paraiba_custo_efetivo@data$Nome_Munic, '</br>Custo efetivo: R$', format(mapa_paraiba_custo_efetivo@data$custo.efetivo, digits = 2, big.mark=".", decimal.mark = ",", scientific = FALSE)),
              fillOpacity = 1) %>%
    addLegend(position = "bottomright", pal = colors, values = mapa_paraiba_custo_efetivo@data$custo.efetivo.log,
            title = "Log de custo efetivo </br> mediano das obras",
            opacity = 1)
```

...
Vamos ver agora qual o tipo de obra mais executada, considerando apenas obras com dimensão maior que zero.
...
mapa_paraiba %>% 
    ...
    addPolygons(opacity = 0.5, 
              ...
              color = 'black', 
              label = mapa_paraiba@data$Nome_Munic,
              popup = paste('Município: ', mapa_paraiba@data$Nome_Munic, '</br>Custo efetivo: R$', format(mapa_paraiba@data$custo_efetivo, digits = 2)),
              fillOpacity = 1) %>%
